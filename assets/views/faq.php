                           ...
                           <div class="panel panel-default">
                               <div class="panel-heading">
                                   <h4 class="panel-title">
                                       <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $value['faqID']; ?>">
                                         <?php echo $value['question']; ?>
                                       </a>
                                  </h4>
                               </div>
                               <div id="collapse<?php echo $value['faqID']; ?>" class="panel-collapse collapse">
                                   <div class="panel-body">
                                       <?php if(!empty ($value['answer'])) echo $value['answer'];?>
                                       <?php if(empty ($value['answer'])) "Not answered yet.";?>
                                   </div>
                               </div>
                           </div>
                        <?php endforeach; ?>    
