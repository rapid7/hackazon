...
require_once(GWTPHP_DIR.'/maps/java/util/Vector.class.php');
require_once(GWTPHP_DIR.'/rpc/core/java/util/AbstractList_CustomFieldSerializer.class.php');

final class Vector_CustomFieldSerializer extends AbstractList_CustomFieldSerializer{
  ...
  public static function instantiate(SerializationStreamReader $streamReader) {
     return (FORCE_CAST_TO_PHP_PRIMITIVE_TYPES) ? array() : new Vector();
  }
	/**
 ...
 */
  public static function serialize(SerializationStreamWriter $streamWriter,
      /*Vector<Object>*/ $instance, MappedClass $instanceClass)  {
