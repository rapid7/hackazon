 ...
 */
require_once(GWTPHP_DIR.'/maps/java/lang/Double.class.php');
...
class Double_CustomFieldSerializer {
	...
	public static function instantiate(SerializationStreamReader $streamReader) {
		return (FORCE_CAST_TO_PHP_PRIMITIVE_TYPES) ? $streamReader->readDouble() : new Double($streamReader->readDouble());
	}
	/**
	 * Enter description here...
	 * @throws SerializationException
