...
<html lang="en">
    ...
    <body>
                ...
                <div id="logincontrol">
                    <div id="loginuser">
                        ...
                        <?php if (!is_null($this->pixie->auth->user())): ?>
                            <a href="/auth/logout" class="login-window" style="color:white">Logout</a>
                        <?php else: ?>
        ...
        <div id="login-box" class="login-popup">
            ...
            <form method="post" class="signin" action="/auth/login" id="loginForm">
                <fieldset class="textbox">
                    ...
                    <p>
                        <a class="forgot" href="/auth/password">Forgot your password?</a>
                        <a class="restore" href="/auth/register">New user?</a>
                    </p>        
                </fieldset>
            </form>
        </div>
