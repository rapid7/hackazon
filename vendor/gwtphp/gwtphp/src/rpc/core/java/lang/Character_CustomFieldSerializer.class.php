 ...
 */
require_once(GWTPHP_DIR.'/maps/java/lang/Character.class.php');
...
class Character_CustomFieldSerializer {
	...
	public static function instantiate(SerializationStreamReader $streamReader) {
		return (FORCE_CAST_TO_PHP_PRIMITIVE_TYPES) ? $streamReader->readChar() : new Character($streamReader->readChar());
	}
	/**
	 * Enter description here...
	 * @throws SerializationException
